...
export LLMDBENCH_VLLM_STANDALONE_EPHEMERAL_STORAGE_REQUEST=${LLMDBENCH_VLLM_STANDALONE_EPHEMERAL_STORAGE_REQUEST:-"10Gi"}
export LLMDBENCH_VLLM_STANDALONE_EPHEMERAL_STORAGE_LIMIT=${LLMDBENCH_VLLM_STANDALONE_EPHEMERAL_STORAGE_LIMIT:-"20Gi"}
