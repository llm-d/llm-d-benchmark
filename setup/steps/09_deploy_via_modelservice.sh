  ...
  - name: "vllm"
    ...
    resources:
      limits:
        ...
        $(echo "$LLMDBENCH_VLLM_COMMON_ACCELERATOR_RESOURCE: \"$(($LLMDBENCH_VLLM_MODELSERVICE_DECODE_TENSOR_PARALLELISM * $LLMDBENCH_VLLM_MODELSERVICE_DECODE_DATA_PARALLELISM))\"" | $LLMDBENCH_CONTROL_SCMD -e "s^: \"\"^^g")
  ...
  - name: "vllm"
    ...
    resources:
      limits:
        ...
        $(echo "$LLMDBENCH_VLLM_COMMON_ACCELERATOR_RESOURCE: \"$(($LLMDBENCH_VLLM_MODELSERVICE_PREFILL_TENSOR_PARALLELISM * $LLMDBENCH_VLLM_MODELSERVICE_PREFILL_DATA_PARALLELISM))\"" | $LLMDBENCH_CONTROL_SCMD -e "s^: \"\"^^g")
