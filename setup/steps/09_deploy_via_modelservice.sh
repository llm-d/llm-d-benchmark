  ...
  - name: "vllm"
    ...
    resources:
      limits:
        ...
        $(echo "$LLMDBENCH_VLLM_COMMON_EPHEMERAL_STORAGE_RESOURCE: \"${LLMDBENCH_VLLM_MODELSERVICE_DECODE_EPHEMERAL_STORAGE_NR}\"")
  ...
  - name: "vllm"
    ...
    resources:
      limits:
        ...
        $(echo "$LLMDBENCH_VLLM_COMMON_EPHEMERAL_STORAGE_RESOURCE: \"${LLMDBENCH_VLLM_MODELSERVICE_PREFILL_EPHEMERAL_STORAGE_NR}\"")
