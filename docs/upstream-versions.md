...
- Generated at: `2026-05-05 05:21:54` (UTC)
- Generated against git ref: `0ea4f1cb9a423919298ae6d7a658c9feeb4236f3`
...
| **helm-diff** | `latest` | plugin (latest) | `install.sh` line 584 (`helm_diff_url`) | [databus23/helm-diff](https://github.com/databus23/helm-diff) |
...
| **jq** | `1.8.1` | version | `install.sh` line 465 (`install_jq_linux`) | [jqlang/jq](https://github.com/jqlang/jq) |
...
| **llm-d-planner (git)** | `f51812bebca30e0291ec541bd2ef2acf0572e8a4` | commit SHA | `install.sh` line 681 (`PLANNER_GIT`) | [llm-d-incubation/llm-d-planner](https://github.com/llm-d-incubation/llm-d-planner) |
