...
|---|---|---|---|---|
| **crane** | `v0.21.6` | version | `install.sh` line 565 (`install_crane_linux`) | [google/go-containerregistry](https://github.com/google/go-containerregistry) |
| **curl** | `8.20.0` | version | `install.sh` line 600 (`install_curl_linux`) | [curl/curl](https://github.com/curl/curl) |
...
| **helm-diff** | `latest` | plugin (latest) | `install.sh` line 702 (`helm_diff_url`) | [databus23/helm-diff](https://github.com/databus23/helm-diff) |
...
| **llm-d-planner (git)** | `e50305af90f0812e77e1827f3bc740fe75b76370` | commit SHA | `install.sh` line 794 (`PLANNER_GIT`) | [llm-d-incubation/llm-d-planner](https://github.com/llm-d-incubation/llm-d-planner) |
