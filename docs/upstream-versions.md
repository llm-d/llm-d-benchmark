...
| **kustomize** | `v5.8.1` | version | `install.sh` line 87 (`tool_version_for`) | [kustomize docs](https://kubectl.docs.kubernetes.io/installation/kustomize/) |
...
| **inferencePool** | `v1.6.2` | tag | `config/templates/values/defaults.yaml` line 494 (`chartVersions.inferencePool`) | [kubernetes-sigs/gateway-api-inference-extension](https://github.com/kubernetes-sigs/gateway-api-inference-extension) |
