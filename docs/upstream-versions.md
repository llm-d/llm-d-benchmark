...
- Generated at: `2026-05-06 05:06:25` (UTC)
- Generated against git ref: `632492fdb6b292871c2fcd4520e005992acfc959`
...
| **curl** | `8.20.0` | version | `install.sh` line 455 (`install_curl_linux`) | [curl/curl](https://github.com/curl/curl) |
...
| **helm-diff** | `latest` | plugin (latest) | `install.sh` line 575 (`helm_diff_url`) | [databus23/helm-diff](https://github.com/databus23/helm-diff) |
...
| **llm-d-planner (git)** | `e50305af90f0812e77e1827f3bc740fe75b76370` | commit SHA | `install.sh` line 672 (`PLANNER_GIT`) | [llm-d-incubation/llm-d-planner](https://github.com/llm-d-incubation/llm-d-planner) |
