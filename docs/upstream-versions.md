...
- Generated at: `2026-05-06 05:26:34` (UTC)
- Generated against git ref: `b55351eb147f815f76519e4e4ec49d02beeda719`
...
|---|---|---|---|---|
| **crane** | `v0.20.3` | version | `install.sh` line 495 (`install_crane_linux`) | [google/go-containerregistry](https://github.com/google/go-containerregistry) |
...
| **helm-diff** | `latest` | plugin (latest) | `install.sh` line 579 (`helm_diff_url`) | [databus23/helm-diff](https://github.com/databus23/helm-diff) |
| **helmfile** | `1.4.2` | version | `install.sh` line 463 (`install_helmfile_linux`) | [helmfile/helmfile](https://github.com/helmfile/helmfile) |
...
| **llm-d-planner (git)** | `e50305af90f0812e77e1827f3bc740fe75b76370` | commit SHA | `install.sh` line 676 (`PLANNER_GIT`) | [llm-d-incubation/llm-d-planner](https://github.com/llm-d-incubation/llm-d-planner) |
| **oc** | `system-provided` | system-provided | `install.sh`: `command -v` check (no pin) | [openshift/oc](https://github.com/openshift/oc) |
| **skopeo** | `v1.14.6` | version | `install.sh` line 510 (`install_skopeo_linux`) | [containers/skopeo](https://github.com/containers/skopeo) |
| **yq** | `v4.52.5` | version | `install.sh` line 455 (`install_yq_linux`) | [mikefarah/yq](https://github.com/mikefarah/yq) |
