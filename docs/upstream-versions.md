...
- Generated at: `2026-04-18 05:02:57` (UTC)
- Generated against git ref: `2993f721ceebf0e238c2d07063c5374f66f9d7ac`
...
| **helm-diff** | `latest` | plugin (latest) | `install.sh` line 435 (`helm_diff_url`) | [databus23/helm-diff](https://github.com/databus23/helm-diff) |
...
| **llm-d-planner (git)** | `f51812bebca30e0291ec541bd2ef2acf0572e8a4` | commit SHA | `install.sh` line 502 (`PLANNER_GIT`) | [llm-d-incubation/llm-d-planner](https://github.com/llm-d-incubation/llm-d-planner) |
| **skopeo** | `v1.20.1` | version | `install.sh` line 377 (`install_skopeo_linux`) | [containers/skopeo](https://github.com/containers/skopeo) |
