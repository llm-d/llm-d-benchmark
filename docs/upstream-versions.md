...
- Generated at: `2026-05-19 05:26:16` (UTC)
- Generated against git ref: `7ee114340e9b99e3785a863a1ae4c642b45009bd`
...
| **curl** | `8.20.0` | version | `install.sh` line 602 (`install_curl_linux`) | [curl/curl](https://github.com/curl/curl) |
...
| **helm-diff** | `latest` | plugin (latest) | `install.sh` line 716 (`helm_diff_url`) | [databus23/helm-diff](https://github.com/databus23/helm-diff) |
...
| **jq** | `1.8.1` | version | `install.sh` line 607 (`install_jq_linux`) | [jqlang/jq](https://github.com/jqlang/jq) |
...
| **llm-d-planner (git)** | `e50305af90f0812e77e1827f3bc740fe75b76370` | commit SHA | `install.sh` line 808 (`PLANNER_GIT`) | [llm-d-incubation/llm-d-planner](https://github.com/llm-d-incubation/llm-d-planner) |
