...
| **curl** | `8_20_0` | version | `install.sh` line 492 (`install_curl_linux`) | [curl/curl](https://github.com/curl/curl) |
...
| **helm-diff** | `latest` | plugin (latest) | `install.sh` line 691 (`helm_diff_url`) | [databus23/helm-diff](https://github.com/databus23/helm-diff) |
| **helmfile** | `1.1.3` | version | `install.sh` line 512 (`install_helmfile_linux`) | [helmfile/helmfile](https://github.com/helmfile/helmfile) |
...
| **llm-d-planner (git)** | `e50305af90f0812e77e1827f3bc740fe75b76370` | commit SHA | `install.sh` line 783 (`PLANNER_GIT`) | [llm-d-incubation/llm-d-planner](https://github.com/llm-d-incubation/llm-d-planner) |
