...
```
cluster-wide / shared
    prometheus-adapter      prometheus-operator-admission-webhook-0.40.0, in openshift-user-workload-monitoring
...
chartVersions:
  ...
  prometheusAdapter: prometheus-operator-admission-webhook-0.40.0
```
