...
gpu_specs = {
    ...
    "NVIDIA-H100-80GB-HBM3": {"memory": 80},
    "NVIDIA-A100-40GB": {"memory": 40},
    "NVIDIA-A100-80GB": {"memory": 80},
    "NVIDIA-H100-80GB": {"memory": 80},
    "NVIDIA-L40-40GB": {"memory": 40},
    "NVIDIA-RTX-4090": {"memory": 24},
    "NVIDIA-RTX-5090": {"memory": 32},
    "NVIDIA-RTX-6000": {"memory": 48},
    "NVIDIA-A6000": {"memory": 48},
    "NVIDIA-A4000": {"memory": 16},
    "NVIDIA-T4": {"memory": 16},
}
