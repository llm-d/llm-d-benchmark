...
def capture_pod_logs(job_name, namespace, output_file: str):
    ...
    try:
        ...
        logs = v1.read_namespaced_pod_log(name=pod_name, namespace=namespace, pretty=True)
...
def main():
    ...
    stack_spec = StackSpec(name=stack_name, stack_type=stack_type, refresh_interval=300, endpoint_url=endpoint_url)
    ...
    try:
        ...
        logger.info("Performing benchmark report conversion")
