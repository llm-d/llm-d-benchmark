...
def teardown_module():
    ...
    if _original_functions is not None:
        sys.modules["functions"] = _original_functions
...
class TestEnsureLocalConda(unittest.TestCase):
    ...
    def test_get_platform_info_macos(self):
        ...
        expected = {"system": "darwin", "machine": "arm64", "is_mac": True, "is_linux": False}
    ...
    def test_get_platform_info_linux(self):
        ...
        expected = {"system": "linux", "machine": "x86_64", "is_mac": False, "is_linux": True}
        self.assertEqual(result, expected)
    ...
    def test_install_miniforge_macos_dry_run(self):
        ...
        exit_code, anaconda_path, conda_sh = module_under_test.install_miniforge_macos(dry_run=True, verbose=True)
    ...
    def test_install_miniforge_macos_success(self):
        ...
        exit_code, anaconda_path, conda_sh = module_under_test.install_miniforge_macos(dry_run=False, verbose=True)
    ...
    def test_install_miniforge_linux_dry_run(self):
        ...
        with patch.object(module_under_test, "get_platform_info") as mock_platform:
            mock_platform.return_value = {"system": "linux", "machine": "x86_64", "is_mac": False, "is_linux": True}

            exit_code, anaconda_path, conda_sh = module_under_test.install_miniforge_linux(dry_run=True, verbose=True)
    ...
    def test_early_exit_when_not_running_locally(self):
        ...
        result = module_under_test.ensure_local_conda(
            run_locally=False, host_os="mac", host_shell="zsh", env_name="test-env", dry_run=True, verbose=True
        )
...
class TestCondaWorkflows(unittest.TestCase):
    ...
    def test_linux_workflow_no_conda(self):
        ...
        with patch.multiple(
            ...
            result = module_under_test.ensure_local_conda(
                run_locally=True, host_os="linux", host_shell="bash", env_name="test-env", dry_run=True, verbose=True
            )
    ...
    def test_source_conda_script_dry_run(self):
        ...
        result = module_under_test.source_conda_script(
            conda_sh=Path("/nonexistent/conda.sh"), dry_run=True, verbose=True
        )
