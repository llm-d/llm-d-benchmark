...
def _do_run(args, logger, render_plan_errors, experiment_file_override=None):
    ...
    context = ExecutionContext(
        ...
        num_requests=getattr(args, "num_requests", None),
...
def _log_env_overrides(logger, args):
    ...
    _ENV_TO_CLI = {
        ...
        "LLMDBENCH_NUM_REQUESTS": ("num_requests", "--num-requests"),
        "LLMDBENCH_CONCURRENCY": ("concurrency", "--concurrency"),
        "LLMDBENCH_SEED": ("seed", "--seed"),
